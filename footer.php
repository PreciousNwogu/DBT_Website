          ...
          <div class="list-wrapper">
            <div class="row row-sm-30">
              <div class="col-sm-4 col-md-4 col-lg-3">
                <p>Styles</p>
                <ul class="list">
                  <li><a href="#" data-waypoint-to="#">Boho Braid</a></li>
                  <li><a href="#" data-waypoint-to="#">Knotless Braid</a></li>
                  <li><a href="#" data-waypoint-to="#">Stitch Braid</a></li>
                  <li><a href="#" data-waypoint-to="#">Feed-in Braid</a></li>
                  <li><a href="#" data-waypoint-to="#">French Braid</a></li>
                  <li><a href="#" data-waypoint-to="#">Twist Braid</a></li>
                </ul>
              </div>
              <div class="col-sm-4 col-md-4 col-lg-3">
                <p>D B T</p>
                <ul class="list">
                  ...
                  <li><a href="#" data-waypoint-to="#">Socials</a></li>
                  <li><a href="#" data-waypoint-to="#">Enquiries</a></li>
          ...
          <div class="row row-sm-30">
            <div class="col-lg-6">
              <div class="group-md group-middle">
                <p class="rights"><span>&copy;&nbsp; </span><span class="copyright-year"></span><span>&nbsp;</span><span>DBT</span><span>.&nbsp;</span><a href="privacy-policy.html">Privacy Policy</a></p>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="text-lg-right">
                <ul class="group-middle card-group-custom">
                  ...
                  <li><a class="icon icon-default icon-sm mdi mdi-instagram" href="https://www.instagram.com/dabs_beauty_touch?igsh=MXYycGNraGxwem5tZw%3D%3D&utm_source=qr"></a></li>
                </ul>
              </div>
            </div>
</body>
