              ...
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-panel">
                  ...
                  <div class="rd-navbar-brand">
                    <a class="brand" href="index.php"><img class="brand-logo-dark" src="images/logo.jpg" alt="" width="100" height="50"/>
                    <p style="margin: 0;">Dab's Beauty Touch</p>
                    </a>
                  </a>
                  </div>
                </div>
                ...
                <div class="rd-nav-item">
                  <div class="btn-wrap"><a class="button button-secondary button-sm" href="form.php">Book Now</a></div>
                </div>
              </div>
            </div>
          </nav>
